...
sleep 120
echo '[+] Beginning dump'
pg_dump "postgresql://mr_root:password@localhost:5433/scratch" -f /home/mcn26/palmer_scratch/post_intersection_dump.sql
echo '[+] Dump complete! Shutting down server.'
pg_ctl -D /home/mcn26/palmer_scratch/db stop &
echo '[+] Waiting 120s for server to stop.'
sleep 120
echo '[+] Zipping dump'
gzip /home/mcn26/palmer_scratch/post_intersection_dump.sql
echo '[+] Done zipping!'
conda deactivate
