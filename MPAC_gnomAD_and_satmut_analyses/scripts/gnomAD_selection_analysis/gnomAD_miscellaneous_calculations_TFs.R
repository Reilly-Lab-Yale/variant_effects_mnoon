...
for (i in paste0("chr", 1:22)) {
	...
	gnomAD_TF_ChIP_seq_chr <- fread(paste0("tabix ../../data/gnomAD_variants_predictions_filtered/gnomad.genomes.v3.1.2.sites.", i, ".filtered.vcf.gz -R ../../data/gnomAD_miscellaneous/tf_chip_seq/chip.for.steve.regions.hg38.bed  | sed 's/;/\t/g' | awk '{print $1, $2, $4, $5, $(NF-8), $(NF-7), $(NF-6), $(NF-5), $(NF-4), $(NF-3), $(NF-2), $(NF-1), $NF}' OFS='\t' | sed -E 's/(K562__ref=|HepG2__ref=|SKNSH__ref=|K562__alt=|HepG2__alt=|SKNSH__alt=|K562__skew=|HepG2__skew=|SKNSH__skew=)//g'"))
...
for (i in paste0("chr", 1:22)) {
	print(paste0("processing ", i))
	gnomAD_noChIP_chr <- fread(paste0("tabix ../../data/gnomAD_variants_predictions_filtered/gnomad.genomes.v3.1.2.sites.", i, ".filtered.vcf.gz -R ../../data/gnomAD_miscellaneous/tf_chip_seq/chip.for.steve.complement.hg38.bed  | sed 's/;/\t/g' | awk '{print $1, $2, $4, $5, $(NF-8), $(NF-7), $(NF-6), $(NF-5), $(NF-4), $(NF-3), $(NF-2), $(NF-1), $NF}' OFS='\t' | sed -E 's/(K562__ref=|HepG2__ref=|SKNSH__ref=|K562__alt=|HepG2__alt=|SKNSH__alt=|K562__skew=|HepG2__skew=|SKNSH__skew=)//g'"))
...
for (i in paste0("chr", 1:22)) {
	print(paste0("processing ", i))
	gnomAD_TF_footprints_chr <- fread(paste0("tabix ../../data/gnomAD_variants_predictions_filtered/gnomad.genomes.v3.1.2.sites.", i, ".filtered.vcf.gz -R ../../data/gnomAD_miscellaneous/tf_footprints/tf.footprints.regions.bed | sed 's/;/\t/g' | awk '{print $1, $2, $4, $5, $(NF-8), $(NF-7), $(NF-6), $(NF-5), $(NF-4), $(NF-3), $(NF-2), $(NF-1), $NF}' OFS='\t' | sed -E 's/(K562__ref=|HepG2__ref=|SKNSH__ref=|K562__alt=|HepG2__alt=|SKNSH__alt=|K562__skew=|HepG2__skew=|SKNSH__skew=)//g'"))
...
for (i in paste0("chr", 1:22)) {
	print(paste0("processing ", i))
	gnomAD_noTF_footprints_chr <- fread(paste0("tabix ../../data/gnomAD_variants_predictions_filtered/gnomad.genomes.v3.1.2.sites.", i, ".filtered.vcf.gz -R ../../data/gnomAD_miscellaneous/tf_footprints/tf.footprints.complement.bed | sed 's/;/\t/g' | awk '{print $1, $2, $4, $5, $(NF-8), $(NF-7), $(NF-6), $(NF-5), $(NF-4), $(NF-3), $(NF-2), $(NF-1), $NF}' OFS='\t' | sed -E 's/(K562__ref=|HepG2__ref=|SKNSH__ref=|K562__alt=|HepG2__alt=|SKNSH__alt=|K562__skew=|HepG2__skew=|SKNSH__skew=)//g'"))
